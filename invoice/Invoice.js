...
export default function Invoice ({ data, pdfMode }) {
      ...
      if (i === index) {
        ...
        if (name === 'description') {
          ...
          if (
            ...
            newProductLine[name] = (n || 0).toString()
          }
        }
      ...
      <Page className="invoice-wrapper" pdfMode={pdfMode}>
        ...
        {invoice.productLines.map((productLine, i) => {
          return pdfMode && productLine.description === '' ? (
            ...
            <View key={i} className="row-pdf flex" pdfMode={pdfMode}>
        ...
        <View className="flex" pdfMode={pdfMode}>
          ...
          <View className="w-50 mt-20" pdfMode={pdfMode}>
            <View className="flex" pdfMode={pdfMode}>
              <View className="w-50 pad-5" pdfMode={pdfMode}>
                <EditableInput
            ...
            <View className="flex bg-gray pad-5" pdfMode={pdfMode}>
              <View className="w-50 pad-5" pdfMode={pdfMode}>
                <EditableInput
                  className="bold"
              ...
              <View className="w-50 pad-5 flex" pdfMode={pdfMode}>
                <EditableInput
